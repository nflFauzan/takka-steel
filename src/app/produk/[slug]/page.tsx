      ...
      <div className="bg-steel-50 pt-24 pb-8 border-b border-steel-100">
        <div className="container-px">
          ...
          <div className="grid gap-10 lg:grid-cols-[1.2fr_1fr] items-center">
            ...
            <div>
              <span className="text-gold text-xs font-bold uppercase tracking-widest mb-2 block">STEEL SPECIFICATION</span>
              <h1 className="font-heading text-4xl font-extrabold text-steel-900 md:text-5xl mb-4">
                {product.name}
              </h1>
              <p className="text-steel-600 leading-relaxed mb-8 text-lg">
                {product.description}
              </p>
          ...
          <div className="mt-12 rounded-2xl bg-steel-950 p-10 overflow-hidden relative">
            ...
            <div className="relative z-10">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-y-4 gap-x-8 text-sm text-steel-300">
                ...
                {/* Fallbacks if uses are few */}
                {product.uses.length < 4 && (
                  <>
                    <div className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-gold"></span> Rangka Plafon & Partisi</div>
                    <div className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-gold"></span> Pagar & Pintu Gerbang</div>
                    <div className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-gold"></span> Furnitur Industrial</div>
                  </>
                )}
              </div>
            </div>
            ...
            {related.map((p) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-xs text-steel-500 mb-4">{p.summary}</p>
